...
export const ButtonSecondary = styled(Base)`
  border: 1px solid ${({ theme }) => lighten(0.2, theme.primary4)};
  color: ${({ theme }) => lighten(0.2, theme.primary4)};
  ...
  &:hover {
    border: 1px solid ${({ theme }) => lighten(0.3, theme.primary4)};
    color: ${({ theme }) => lighten(0.3, theme.primary4)};
  }
